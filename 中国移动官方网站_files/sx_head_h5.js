var headData = {
  ...
  "hotWordsJson":[{"name":"宽带","href":"http://search.10086.cn//search?content=%E5%AE%BD%E5%B8%A6&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"},{"name":"彩铃","href":"http://search.10086.cn//search?content=%E5%BD%A9%E9%93%83&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"},{"name":"停机保号","href":"http://search.10086.cn//search?content=%E5%81%9C%E6%9C%BA%E4%BF%9D%E5%8F%B7&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"},{"name":"4G+高清语音","href":"http://search.10086.cn//search?content=4G%2B%E9%AB%98%E6%B8%85%E8%AF%AD%E9%9F%B3&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"},{"name":"密码重置","href":"http://search.10086.cn//search?content=%E5%AF%86%E7%A0%81%E9%87%8D%E7%BD%AE&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"},{"name":"4G流量卡","href":"http://search.10086.cn//search?content=4G%E6%B5%81%E9%87%8F%E5%8D%A1&start=1&field=&host=&pagesize=10&datetime=all&areacode=351","editable":"3","responsible":"0","isEdit":"0","highLight":"0"}],
...
$(document).ready(function(){
  ...
  //加载卷帘
  if((location.pathname.toLowerCase().indexOf("/sx") == 0 || location.pathname.toLowerCase().indexOf("/sample/indexsample") == 0) && ("1"=="1")){
    autoAdd();
  }
  //搜索区域
...
function autoAdd(){
  ...
  showAds(360,360,360);
  var yxURLbig ="http://shop.10086.cn/hd/517/index.html";
  var yxURLsmall = "http://shop.10086.cn/hd/517/index.html";
  top_bgads.innerHTML="<button onclick='javascript:if(typeof(_tag)!= \"undefined\"){_tag.dcsMultiTrack(\"WT.event\",\"INDEX_AD_JL_sx\");};window.open(\""+yxURLbig+"\");'id=\"header_zzjs_net_ad\"><img src='/sx_head/cmpop/images/index/ad1/201605/20160518173030910cl5.jpg'></button><div id='close' onclick='javascript:closeAd();'><img src='/sx_head/cmpop/images/index/ad1/201605/20160518173100807t6k.gif'></img></div>";
  ...
  top_smalldiv.innerHTML="<a onclick='javascript:if(typeof(_tag)!= \"undefined\"){_tag.dcsMultiTrack(\"WT.event\",\"INDEX_AD_banner_sx\");};' target='_blank' href="+yxURLsmall+"><img src='/sx_head/cmpop/images/index/ad1/201605/20160518173044127Mxn.jpg'></a><div id='closex' onclick='javascript:closeAd2();'><img src='/sx_head/cmpop/images/index/ad1/201605/20160518173108714B6A.gif'></img></div>";
}
// html编码函数
